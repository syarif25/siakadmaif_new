<div class="page-wrapper">
        <div class="page-content">
          ...
          <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Selamat Datang <b> <?php echo $this->session->userdata('username')?></b></div>
            <div class="ps-3"></div>
            <div class="ms-auto">
                    ...
                    <div class="card-body">
                      <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <div class="mt-3">
                          ...
                          <p class="text-secondary mb-1">NIS : 2019.01.1234 | NPM : 12346783</p>
                          <p class="text-secondary mb-1">Takhassus : Fiqh dan Ushul Fiqh</p>
                  ...
                  <div class="card radius-10 w-100">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div>
                          <h5 class="mb-1">Jadwal Perkuliahan</h5>
                          <p class="mb-0 font-13 text-secondary"><i class="bx bxs-calendar"></i>Semester 3 Marhalah Ula</p>
                        </div>
                        ...
                        <table class="table align-middle mb-0 table-hover" id="Transaction-History">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <strong>Dr. A. Muhyiddin Khotib M.H.I</strong>
                              </td>
                            </tr>
                            <tr>
                              <td>2</td>
                              ...
                              <td>
                                <strong>Prof., Dr. H ABU YASID MA., LL.M.</strong>
                              </td>
                            </tr>
                            <tr>
                              <td>3</td>
                              ...
                              <td>
                                <strong>Ahmad Rofiqi M.Ag.</strong>
                              </td>
                            </tr>
                            <tr>
                              <td>4</td>
                              ...
                              <td>
                                <strong>Ali Murtadlo S.Ag</strong>
                              </td>
                            </tr>
                            <tr>
                              <td>5</td>
                              ...
                              <td>
                                <strong>Dr Maskuri M.Pd.I</strong>
                              </td>
                            </tr>
                            <tr>
                              <td>6</td>
                              <td>Tasawwuf</td>
                              <td>2 sks</td>
                              <td class="text-success">Kamis 15.00 - 16.30</td>
                              <td>
                                <strong> Dr Miftahus Surur MH</strong>
                              </td>
                            </tr>
                          </tbody>
                        </table>
