      ...
      <div class="page-wrapper">
        <div class="page-content">
          ...
          <button id="btnAdd"
                  ...
                  data-bs-target="#modal_mahasiswa">
            <i class="bx bx-user-plus"></i> Tambah Mahasiswa
          </button>

          <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal_import">
            <i class="bx bx-upload"></i> Import Excel
          </button>
          <a class="btn btn-info" href="<?= base_url('assets/template_mahasiswa.xlsx') ?>">
