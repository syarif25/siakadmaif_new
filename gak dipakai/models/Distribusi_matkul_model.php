...
class Distribusi_matkul_model extends CI_Model {
	...
	// Cek konflik ruangan/kelas pada hari dan jam tertentu, kecuali data update (id_distribusi)
public function checkConflictRoom($id_kelas, $hari, $jam_mulai, $jam_selesai, $id_distribusi = null)
{
    $this->db->from('distribusi_mk');
    ...
    // Cek overlap jam (jam mulai - jam selesai) intersect
    $this->db->group_start();
...
public function checkConflictDosen($id_dosen, $hari, $jam_mulai, $jam_selesai, $id_distribusi = null)
{
    $this->db->from('distribusi_mk');
...
// Cek duplikasi distribusi matakuliah
public function checkDuplicateDistribusi($id_kelas, $id_mk, $id_dosen, $hari, $jam_mulai, $jam_selesai, $id_distribusi = null)
{
    $this->db->from('distribusi_mk');
    $this->db->where('id_kelas', $id_kelas);
...
public function get_mahasiswa_by_distribusi($id_distribusi)
{
    ...
    $this->db->where('dk.status_keanggotaan', 'Aktif');
