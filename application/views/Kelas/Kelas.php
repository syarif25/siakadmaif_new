...
<div class="page-wrapper">
  <div class="page-content">
    ...
    <button class="btn btn-warning radius-30" onclick="add()"><i class="bx bx-plus"></i> Tambah Kelas</button>
    <!-- Modal -->
        ...
        <div class="table-responsive">
          <table id="tabel_view" class="table table-striped table-bordered">
            <thead>
              ...
              <tr class="filters">
                  <th></th> <!-- No column -->
                  <th><input type="text" class="form-control form-control-sm" placeholder="Cari Angkatan" /></th>
                  <th><input type="text" class="form-control form-control-sm" placeholder="Cari Nama Kelas" /></th>
